...
const SensorRouter_1 = require("./alarmaSensor/infrastructure/SensorRouter");
const MysqlAlarmaRepository_1 = require("./alarmaSensor/infrastructure/MysqlAlarmaRepository");
class App {
    constructor() {
    ...
    configure() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sensorRepository = new MysqlAlarmaRepository_1.MysqlAlarmaRepository();
            const allAlertaData = yield sensorRepository.getAll();
            // Envía todos los datos a los clientes conectados al iniciar la aplicación
            if (this.io && allAlertaData) {
                (0, WebsocketRouter_1.sendUpdatedDataToClients)(allAlertaData);
            }
        });
    }
    socketServer() {
